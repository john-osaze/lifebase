...
import EditAppointmentComponents from "../EditAppointmentComponents/EditAppointmentComponents";
...
const VaccinateUserTable = () => {
    ...
    return (
        <div>
            ...
            <Modal
              className="vaccinate-appointment-edit-modal--content"
              show={show}
              backdrop="static"
              keyboard={false}
            ...
            >
              ...
              <Modal.Body>
                <EditAppointmentComponents></EditAppointmentComponents>
              </Modal.Body>
              <Modal.Footer>
